...
## 3. Архитектурная задача (`Архитектурная задача.pdf`)

Предложение по архитектуре для обслуживания 1200 outreach-адресов находится в файле `Архитектурная задача.pdf`.
